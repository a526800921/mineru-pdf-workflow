...
- `skills/pdf2md/SKILL.md`：承载从 audit 到 repair、人工/VLM确认和回滚的统一协作入口；原 `pdf2md-fix` skill 已在迁移计划阶段 5 废弃。
- `/Users/jafish/.claude/skills/pdf2md/SKILL.md`：同步项目级主入口的公共契约。
...
- `skills/pdf2md/SKILL.md` 已承载人工检查顺序、`qwen3-vl-8b`、ModelPad `9999` 管理端口和 VLM `9005` 服务端点；VLM 只能提供文字/数字/视觉证据，不得判断行列结构或直接形成最终结论。
