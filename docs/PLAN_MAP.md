...
| [pdf-table-audit](plans/pdf-table-audit.md) | 待实施 | 阶段 2：skill 与人工/VLM流程同步 | 2026-07-12 | pdf2md-fix-manual-workflow、pdf-merge-table-formatting、pdf-output-package-layout、PyMuPDF、现有 `scripts/pdf-table-fix`；阶段 1 已通过，项目级/用户级 skill 已同步，阶段 2 字段清单和操作示例待补入 | [阶段 2 待实施准入复核](plans/pdf-table-audit.md#阶段-2-待实施准入复核2026-07-12) |
| [toc-target-page-coordinate-fix](plans/toc-target-page-coordinate-fix.md) | 实施中 | 阶段 1 已完成 → 阶段 2：下游消费者兼容 | 2026-07-12 | toc-page-physical-attribution-fix、pdf-extract-data-table-coverage、pdf-output-package-layout、pdf2md-fix-manual-workflow、真实页码偏移报告；春风250Sr物理页锚点已复核 | [阶段 1 完成证据](plans/toc-target-page-coordinate-fix.md#阶段-1-完成证据2026-07-12) |
