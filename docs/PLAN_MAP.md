...
| [pdf-table-audit](plans/pdf-table-audit.md) | 实施中 | 阶段 1 再次验收未通过 — 重复 page_anchor 校验补强 | 2026-07-12 | pdf2md-fix-manual-workflow、pdf-merge-table-formatting、pdf-output-package-layout、PyMuPDF、现有 `scripts/pdf-table-fix`；失败回滚已通过，重复页锚点仍阻塞 | [阶段 1 再次独立验收](plans/pdf-table-audit.md#阶段-1-再次独立验收2026-07-12仍未通过) |
