...
| [toc-target-page-coordinate-fix](plans/toc-target-page-coordinate-fix.md) | 已完成 | 全阶段（0-4）已完成，全计划闭环 | 2026-07-13 | toc-page-physical-attribution-fix、pdf-extract-data-table-coverage、pdf-output-package-layout、pdf2md-fix-manual-workflow、阶段 0-4 逐项验收：页码检测/标准化/消费者门禁/真实样本/独立验收通过、310 tests pass | [阶段 4 独立验收](plans/toc-target-page-coordinate-fix.md#阶段-4-独立验收2026-07-13通过) |
| [pdf-table-repair](plans/pdf-table-repair.md) | 实施中 | 阶段 2：人工/VLM确认与安全应用（已完成） | 2026-07-13 | pdf-table-audit、pdf2md-fix-manual-workflow、per-page-anchors、pdf-merge-table-formatting、pdf-apply-fixes 页锚点安全替换、PyMuPDF、固定 qwen3-vl-8b | [阶段 2 完成证据](plans/pdf-table-repair.md#阶段-2-完成证据2026-07-13) |
