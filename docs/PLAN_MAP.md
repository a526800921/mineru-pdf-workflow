...
| [pdf-table-audit](plans/pdf-table-audit.md) | 实施中 | 阶段 2 已完成 — 阶段 3：真实样本扩展 | 2026-07-12 | pdf2md-fix-manual-workflow、pdf-merge-table-formatting、pdf-output-package-layout、PyMuPDF、现有 `scripts/pdf-table-fix`；阶段 1 已通过，项目级/用户级 skill 已同步，阶段 2 技能文档已完成 | [阶段 2 完成证据](plans/pdf-table-audit.md#阶段-2-完成证据2026-07-12) |
| [toc-target-page-coordinate-fix](plans/toc-target-page-coordinate-fix.md) | 实施中 | 阶段 1 独立验收未通过，修复后重验；阶段 2 未准入 | 2026-07-12 | toc-page-physical-attribution-fix、pdf-extract-data-table-coverage、pdf-output-package-layout、pdf2md-fix-manual-workflow、真实页码偏移报告；实现测试通过，但真实包 page_numbering/review 证据和歧义边界仍缺失 | [阶段 1 独立验收复核](plans/toc-target-page-coordinate-fix.md#阶段-1-独立验收复核2026-07-12) |
