...
| [toc-page-physical-attribution-fix](plans/toc-page-physical-attribution-fix.md) | 实施中 | 阶段 2：合并与兼容路径接入（阶段 1 已完成） | 2026-07-11 | coverage-validation-optimization、per-page-anchors、pdf-auto-repair-before-merge、demo20 目录页真实样本 | [阶段 1 完成证据](plans/toc-page-physical-attribution-fix.md#阶段-1-完成证据2026-07-11) |
