...
| [table-text-omission-detection](plans/table-text-omission-detection.md) | 实施中 | 阶段 3：真实样本与边界验收 | 2026-07-11 | single-page-segmentation-migration 阶段 3、pdf-evaluation-suite P4b、PyMuPDF 原生文本层、demo20 p16 证据 | [阶段 2 完成证据](plans/table-text-omission-detection.md#阶段-2-完成证据2026-07-11) |
