...
| [pdf-table-audit](plans/pdf-table-audit.md) | 实施中 | 阶段 1 已完成 — 阶段 2：skill 与人工/VLM流程同步 | 2026-07-12 | pdf2md-fix-manual-workflow、pdf-merge-table-formatting、pdf-output-package-layout、PyMuPDF、现有 `scripts/pdf-table-fix`；Step 0 三包复现和三类信号/manifest 契约已冻结 | [阶段 1 完成证据](plans/pdf-table-audit.md#阶段-1-完成证据2026-07-12) |
| [toc-target-page-coordinate-fix](plans/toc-target-page-coordinate-fix.md) | 待实施 | 阶段 1：TOC 标准化与 manifest 登记 | 2026-07-12 | toc-page-physical-attribution-fix、pdf-extract-data-table-coverage、pdf-output-package-layout、pdf2md-fix-manual-workflow、真实页码偏移报告；春风250Sr物理页锚点已复核 | [阶段 0 准入复核](plans/toc-target-page-coordinate-fix.md#阶段-0-准入复核2026-07-12) |
