...
| [pdf-table-audit](plans/pdf-table-audit.md) | 实施中 | 阶段 3 已完成 — 阶段 4：独立验收 | 2026-07-12 | pdf2md-fix-manual-workflow、pdf-merge-table-formatting、pdf-output-package-layout、PyMuPDF、现有 `scripts/pdf-table-fix`；阶段 1-3 已完成，报告样本 9/9 覆盖，三包统计闭环 | [阶段 3 完成证据](plans/pdf-table-audit.md#阶段-3-完成证据2026-07-12) |
| [toc-target-page-coordinate-fix](plans/toc-target-page-coordinate-fix.md) | 实施中 | 阶段 1 二次验收独立复核未通过，修复后重验；阶段 2 未准入 | 2026-07-12 | toc-page-physical-attribution-fix、pdf-extract-data-table-coverage、pdf-output-package-layout、pdf2md-fix-manual-workflow、真实页码偏移报告；页码契约中间产物通过，但最终 review 重写会丢失坐标系证据，春风250Sr条目数量证据漂移 | [阶段 1 二次验收独立复核](plans/toc-target-page-coordinate-fix.md#阶段-1-二次验收独立复核2026-07-12未通过) |
