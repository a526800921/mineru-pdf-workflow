...
| [toc-page-physical-attribution-fix](plans/toc-page-physical-attribution-fix.md) | 实施中 | 阶段 3：真实样本与回归验收（待验收 demo20toc2 多页归属样本） | 2026-07-11 | coverage-validation-optimization、per-page-anchors、pdf-auto-repair-before-merge、demo20/demo5/demo60 真实样本、`pdf/demo20toc2/demo20toc2.pdf` p3/p4 多页目录归属样本 | [阶段 3 独立验收](plans/toc-page-physical-attribution-fix.md#阶段-3-独立验收2026-07-11) |
