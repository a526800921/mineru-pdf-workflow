...
| [table-text-omission-detection](plans/table-text-omission-detection.md) | 待实施 | 阶段 1：通用原生表格检测器 | 2026-07-11 | single-page-segmentation-migration 阶段 3、pdf-evaluation-suite P4b、PyMuPDF 原生文本层、demo20 p16 证据 | [待实施门禁复核](plans/table-text-omission-detection.md#待实施门禁复核2026-07-11) |
