...
| [marker-feature-absorption](plans/marker-feature-absorption.md) | 实施中 | 阶段 3 已完成（分步进度 + 耗时），阶段 4 候选 | pdf-output-package-layout、automated-pdf-pipeline | [阶段 3 完成证据](plans/marker-feature-absorption.md#阶段-3-完成证据2026-06-30) |
...
| marker-feature-absorption | 阶段 0-2 | 详见 [marker 特性吸纳计划](plans/marker-feature-absorption.md#阶段-2-完成证据2026-06-30) |
