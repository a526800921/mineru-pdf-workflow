...
| [table-text-omission-detection](plans/table-text-omission-detection.md) | 实施中 | 阶段 4：整表头/顶部列头漏报补强（实施完成，待用户验收） | 2026-07-11 | single-page-segmentation-migration 阶段 3、pdf-evaluation-suite P4b、PyMuPDF 原生文本层、demo20 p14/p16 真实样本 | [阶段 4 实施记录](plans/table-text-omission-detection.md#阶段-4-实施记录2026-07-11) |
