...
| [table-text-omission-detection](plans/table-text-omission-detection.md) | 实施中 | 阶段 2：接入既有 fallback 闭环（缺口已修复，待复验） | 2026-07-11 | single-page-segmentation-migration 阶段 3、pdf-evaluation-suite P4b、PyMuPDF 原生文本层、demo20 p16 证据 | [阶段 2 修复记录](plans/table-text-omission-detection.md#阶段-2-修复记录2026-07-11) |
