...
| [marker-feature-absorption](plans/marker-feature-absorption.md) | 实施中 | 阶段 2 已完成（探针报告机制），阶段 3 候选 | pdf-output-package-layout、automated-pdf-pipeline | [阶段 2 完成证据](plans/marker-feature-absorption.md#阶段-2-完成证据2026-06-30) |
...
| marker-feature-absorption | 阶段 0-1 | 详见 [marker 特性吸纳计划](plans/marker-feature-absorption.md#阶段-1-完成证据2026-06-30) |
