...
| [pdf-table-audit](plans/pdf-table-audit.md) | 实施中 | 阶段 4 已达到待实施标准 | 2026-07-13 | pdf2md-fix-manual-workflow、pdf-merge-table-formatting、pdf-output-package-layout、PyMuPDF、现有 `scripts/pdf-table-fix`；阶段 3 已独立验收，阶段 4 Step 0、范围、验证和完成条件已冻结 | [阶段 4 待实施准入](plans/pdf-table-audit.md#阶段-4-待实施准入-2026-07-13) |
| [toc-target-page-coordinate-fix](plans/toc-target-page-coordinate-fix.md) | 实施中 | 阶段 2 验收未通过，待补齐；阶段 3 暂不准入 | 2026-07-13 | toc-page-physical-attribution-fix、pdf-extract-data-table-coverage、pdf-output-package-layout、pdf2md-fix-manual-workflow、阶段 2 消费者兼容实现；`proposed`/最终导出门禁、前后差异证据和 pdf2md skill 同步未闭环 | [阶段 2 独立验收复核](plans/toc-target-page-coordinate-fix.md#阶段-2-独立验收复核2026-07-13未通过) |
