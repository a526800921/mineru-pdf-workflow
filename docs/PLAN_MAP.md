...
| [toc-page-physical-attribution-fix](plans/toc-page-physical-attribution-fix.md) | 已完成 | 全阶段（1-3）：物理页归属、合并与兼容路径、真实样本验收 | 2026-07-11 | coverage-validation-optimization、per-page-anchors、pdf-auto-repair-before-merge、demo20/demo5/demo60 目录页真实样本 | [阶段 1 完成证据](plans/toc-page-physical-attribution-fix.md#阶段-1-完成证据2026-07-11)、[阶段 2 完成证据](plans/toc-page-physical-attribution-fix.md#阶段-2-完成证据2026-07-11)、[阶段 3 完成证据](plans/toc-page-physical-attribution-fix.md#阶段-3-完成证据2026-07-11) |
