...
| [structured-data-extraction](plans/structured-data-extraction.md) | 实施中 | 阶段 2 已完成（HTML表+单位拆分+审核口径），阶段 3 候选 | pdf-output-package-layout、coverage-validation-optimization、demo20 输出包 | [阶段 2 完成证据](plans/structured-data-extraction.md#阶段-2-完成证据2026-07-01) |
...
| structured-data-extraction | 阶段 0-2 | 详见 [输出包结构化数据抽取计划](plans/structured-data-extraction.md#阶段-2-完成证据2026-07-01) |
