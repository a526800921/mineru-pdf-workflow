...
| [pdf2md-fix-manual-workflow](plans/pdf2md-fix-manual-workflow.md) | 实施中 | 阶段 3：结构化数据与入库审核衔接 | 2026-07-12 | `pdf-output-package-layout`、`pdf-merge`、`pdf-auto`、`pdf-auto-repair-before-merge`、`review.md`、`pdf-evaluation-suite`、`local-vlm-autostart`、`table-text-omission-detection`、`structured-data-extraction`、`data-ingestion-pipeline`、`conflict-context-ingestion-fix`、demo20/demo60 8192 空列实测、p37/p47/p48 全局 replace 漂移复盘、demo20 p14-p16、阶段 1 skill 校验与用户级同步、阶段 2 契约决策、阶段 2 回归测试 38/38、全量 Python 135 passed、阶段 2 最终验收、阶段 3 Step 0 上游证据、阶段 3 F1-F5 53/53、rekey/suppress 独立 fixture 失败 | [阶段 3 独立验收复核](plans/pdf2md-fix-manual-workflow.md#阶段-3-独立验收复核2026-07-12) |
