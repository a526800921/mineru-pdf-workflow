...
| [llm-human-collaboration-migration](plans/llm-human-collaboration-migration.md) | 实施中 | 阶段 1：统一 `pdf2md` 编排入口 | 2026-07-15 | `pdf2md-fix-manual-workflow`、`pdf-table-repair`、`pdf-extract-data-table-coverage`、`data-ingestion-pipeline`、`cli-only-migration`、ADR 0003 | 阶段 1 独立验收通过并已关闭；阶段 2 动态辅助脚本安全层、阶段 3 `pdf2md-fix` 兼容迁移尚未启动 | [阶段 1 独立验收](plans/llm-human-collaboration-migration.md#阶段-1-独立验收2026-07-15) |
