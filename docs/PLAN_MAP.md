...
| [pdf-table-audit](plans/pdf-table-audit.md) | 实施中 | 阶段 3 再次验收未通过 — 真实包产物与统计矩阵漂移修复 | 2026-07-13 | pdf2md-fix-manual-workflow、pdf-merge-table-formatting、pdf-output-package-layout、PyMuPDF、现有 `scripts/pdf-table-fix`；demo20 候选引用悬空，manual_fixes hash 和多样本 VLM/统计证据仍不完整 | [阶段 3 再次独立验收复核](plans/pdf-table-audit.md#阶段-3-再次独立验收复核2026-07-13仍未通过) |
| [toc-target-page-coordinate-fix](plans/toc-target-page-coordinate-fix.md) | 实施中 | 阶段 3：真实样本回填（待实施） | 2026-07-13 | toc-page-physical-attribution-fix、pdf-extract-data-table-coverage、pdf-output-package-layout、pdf2md-fix-manual-workflow、阶段 2 三消费者兼容：提取 warning、入库门禁、校验 schema、250 tests pass | [阶段 2 实施证据](plans/toc-target-page-coordinate-fix.md#阶段-2-实施证据2026-07-13) |
