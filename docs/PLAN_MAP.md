...
| [toc-target-page-coordinate-fix](plans/toc-target-page-coordinate-fix.md) | 实施中 | 阶段 3：真实样本回填（待实施） | 2026-07-13 | toc-page-physical-attribution-fix、pdf-extract-data-table-coverage、pdf-output-package-layout、pdf2md-fix-manual-workflow、阶段 2 第二轮验收：proposed阻断/export门禁/消费者差异/skill同步、256 tests pass | [阶段 3 待实施准入复核](plans/toc-target-page-coordinate-fix.md#阶段-3-待实施准入复核2026-07-13) |
