...
| [table-text-omission-detection](plans/table-text-omission-detection.md) | 实施中 | 阶段 1：通用原生表格检测器边界修复 | 2026-07-11 | single-page-segmentation-migration 阶段 3、pdf-evaluation-suite P4b、PyMuPDF 原生文本层、demo20 p16 证据 | [阶段 1 验收](plans/table-text-omission-detection.md#阶段-1-验收记录2026-07-11) |
