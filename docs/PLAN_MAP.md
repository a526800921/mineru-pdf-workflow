...
| [toc-page-physical-attribution-fix](plans/toc-page-physical-attribution-fix.md) | 实施中 | 阶段 3：真实样本与回归验收（阶段 1、阶段 2 已完成） | 2026-07-11 | coverage-validation-optimization、per-page-anchors、pdf-auto-repair-before-merge、demo20 目录页真实样本 | [阶段 2 完成证据](plans/toc-page-physical-attribution-fix.md#阶段-2-完成证据2026-07-11) |
