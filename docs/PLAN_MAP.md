...
| [pdf-table-audit](plans/pdf-table-audit.md) | 实施中 | 阶段 1 验收未通过 — 候选/manifest 写入失败回滚补强 | 2026-07-12 | pdf2md-fix-manual-workflow、pdf-merge-table-formatting、pdf-output-package-layout、PyMuPDF、现有 `scripts/pdf-table-fix`；三包扫描与候选 schema 已验证，失败回滚仍阻塞 | [阶段 1 独立验收](plans/pdf-table-audit.md#阶段-1-独立验收2026-07-12未通过) |
