...
| [llm-human-collaboration-migration](plans/llm-human-collaboration-migration.md) | 实施中 | 阶段 2：动态辅助脚本安全执行层 | 2026-07-15 | `pdf2md-fix-manual-workflow`、`pdf-table-repair`、`pdf-extract-data-table-coverage`、`data-ingestion-pipeline`、`cli-only-migration`、ADR 0003 | 阶段 1、阶段 2 已独立验收关闭；阶段 3 尚未启动，需完成自身 Step 0 后再准入 | [阶段 2 修复后独立验收](plans/llm-human-collaboration-migration.md#阶段-2-独立验收修复后2026-07-15) |
