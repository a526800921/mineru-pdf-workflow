...
| [pdf2md-fix-manual-workflow](plans/pdf2md-fix-manual-workflow.md) | 已完成 | 全阶段（0-4）：真实样本扩展与收敛已完成 | 2026-07-12 | `pdf-output-package-layout`、`pdf-merge`、`pdf-auto`、`pdf-auto-repair-before-merge`、`review.md`、`pdf-evaluation-suite`、`local-vlm-autostart`、`table-text-omission-detection`、`structured-data-extraction`、`data-ingestion-pipeline`、`conflict-context-ingestion-fix`、demo20/demo60 8192 空列实测、p37/p47/p48 全局 replace 漂移复盘、demo20 p14-p16、demo20 VLM 评测、春风冲突样本、阶段 1-3 全部验收、阶段 4 真实样本验收矩阵 | [阶段 4 完成证据](plans/pdf2md-fix-manual-workflow.md#阶段-4-完成证据2026-07-12) |
