...
| [pdf-table-repair](plans/pdf-table-repair.md) | 实施中 | 阶段 3：真实样本扩展（待实施） | 2026-07-13 | 阶段 3 Step 0、样本矩阵和失败边界已冻结；阶段 2 apply/reject、manifest 同步、语义表格一致性豁免、失败字节级回滚已通过验收；125/125 shell、54/54 table repair、310 pytest | [阶段 3 待实施准入复核](plans/pdf-table-repair.md#阶段-3-待实施准入复核2026-07-13) |
