...
| [structured-data-extraction](plans/structured-data-extraction.md) | 实施中 | 阶段 1 已完成（pdf-extract-data 脚本），阶段 2 候选 | pdf-output-package-layout、coverage-validation-optimization、demo20 输出包 | [阶段 1 完成证据](plans/structured-data-extraction.md#阶段-1-完成证据2026-07-01) |
...
| structured-data-extraction | 阶段 0-1 | 详见 [输出包结构化数据抽取计划](plans/structured-data-extraction.md#阶段-1-完成证据2026-07-01) |
