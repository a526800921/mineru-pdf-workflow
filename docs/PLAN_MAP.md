...
| [per-page-anchors](plans/per-page-anchors.md) | 实施中 | 阶段 2/3 待实施（阶段 0/1 已完成，M-1/M-2/粘行已修并独立复验） | automated-pdf-pipeline、pdf-output-package-layout、coverage-validation-optimization、structured-data-extraction、春风 150AURA 输出包 | [阶段 1 验收记录](plans/per-page-anchors.md#阶段-1-验收记录2026-07-08) |
