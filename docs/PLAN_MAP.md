...
| [data-ingestion-pipeline](plans/data-ingestion-pipeline.md) | 实施中 | 阶段 2 已完成（审核流转+冲突报告），阶段 3 候选 | structured-data-extraction、pdf-output-package-layout、demo20 数据草案 | [阶段 2 完成证据](plans/data-ingestion-pipeline.md#阶段-2-完成证据2026-07-02) |
