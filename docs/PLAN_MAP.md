...
| [llm-human-collaboration-migration](plans/llm-human-collaboration-migration.md) | 实施中 | 阶段 2：动态辅助脚本安全执行层 | 2026-07-15 | `pdf2md-fix-manual-workflow`、`pdf-table-repair`、`pdf-extract-data-table-coverage`、`data-ingestion-pipeline`、`cli-only-migration`、ADR 0003 | 阶段 1 已独立验收关闭；阶段 2 Step 0 已通过并进入安全执行层实施；阶段 3 尚未启动 | [阶段 2 Step 0 独立准入复核](plans/llm-human-collaboration-migration.md#阶段-2-step-0-独立准入复核2026-07-15) |
