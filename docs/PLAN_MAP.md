...
| [pdf-table-audit](plans/pdf-table-audit.md) | 实施中 | 阶段 3 已完成 — 阶段 4：独立验收 | 2026-07-13 | pdf2md-fix-manual-workflow、pdf-merge-table-formatting、pdf-output-package-layout、PyMuPDF、现有 `scripts/pdf-table-fix`；三包候选/manual_fixes/VLM/manifest 已闭环，统计矩阵已保存 | [阶段 3 通过证据](plans/pdf-table-audit.md#阶段-3-再次独立验收2026-07-13通过) |
| [toc-target-page-coordinate-fix](plans/toc-target-page-coordinate-fix.md) | 实施中 | 阶段 2：下游消费者兼容（待实施） | 2026-07-13 | toc-page-physical-attribution-fix、pdf-extract-data-table-coverage、pdf-output-package-layout、pdf2md-fix-manual-workflow、阶段 1 四包准确 TOC 范围 fixture、最终 review 证据、manifest/hash 和幂等复核通过 | [阶段 2 待实施准入复核](plans/toc-target-page-coordinate-fix.md#阶段-2-待实施准入复核2026-07-13) |
