...
| [parent-context-review-suggestions](plans/parent-context-review-suggestions.md) | 已完成 | 阶段 2：真实 PDF 包只读演练 | 2026-07-19 | parent-context-upstream-enrichment、data-ingestion-pipeline | [阶段 2 实施证据](plans/parent-context-review-suggestions.md#阶段-2-实施证据2026-07-19) |
...
| [candidate-identity-business-value-decoupling](plans/candidate-identity-business-value-decoupling.md) | 已完成 | 阶段 3：契约同步与独立验收 | 2026-08-12 | 150Sc 会话复盘、structured-data-extraction、data-ingestion-pipeline、llm-first-review-workflow-hardening、review-artifact-rebuild-safety、extraction-coverage-reconciliation | [阶段 3 完成验收](plans/candidate-identity-business-value-decoupling.md#最新独立准入复核) |
...
| [extraction-coverage-reconciliation](plans/extraction-coverage-reconciliation.md) | 已完成 | 阶段 4：更新 pdf2md skill、完成独立验收和治理收尾 | 2026-07-19 | pdf-extract-data-table-coverage、structured-data-extraction、data-ingestion-pipeline、parent-context-upstream-enrichment | coverage context/gate、Aura 可回放 e2e、备份恢复、skill 同步和独立验收均通过；正式调整 parent_key 保持不变 | [阶段 3/4 完成证据](plans/extraction-coverage-reconciliation.md#阶段-34-完成证据2026-07-19) |
