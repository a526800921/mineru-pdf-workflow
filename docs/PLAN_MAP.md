...
| [llm-human-collaboration-migration](plans/llm-human-collaboration-migration.md) | 实施中 | 阶段 2：动态辅助脚本安全执行层 | 2026-07-15 | `pdf2md-fix-manual-workflow`、`pdf-table-repair`、`pdf-extract-data-table-coverage`、`data-ingestion-pipeline`、`cli-only-migration`、ADR 0003 | 阶段 1 已独立验收关闭；阶段 2 核心安全 fixture 已通过，但独立验收不通过，待补 apply 后验证和审批/入库前门禁证明；阶段 3 尚未启动 | [阶段 2 独立验收](plans/llm-human-collaboration-migration.md#阶段-2-独立验收2026-07-15) |
