...
| [pdf-workflow-enhancement-roadmap](plans/pdf-workflow-enhancement-roadmap.md) | 待实施 | P3b：向量化前置准备（chunks.jsonl 导出） | 所有已完成计划、P3a 检索工具、春风 150AURA 输出包 | [P3a 完成](https://github.com/user/repo/commit/0fc6e19) |
