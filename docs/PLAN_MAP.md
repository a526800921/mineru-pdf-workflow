...
| [pdf2md-fix-manual-workflow](plans/pdf2md-fix-manual-workflow.md) | 实施中 | 阶段 2：修复记录与派生产物应用 | 2026-07-12 | `pdf-output-package-layout`、`pdf-merge`、`pdf-auto`、`pdf-auto-repair-before-merge`、`review.md`、`pdf-evaluation-suite`、`local-vlm-autostart`、`table-text-omission-detection`、`structured-data-extraction`、`data-ingestion-pipeline`、demo20/demo60 8192 空列实测、p37/p47/p48 全局 replace 漂移复盘、demo20 p14-p16、阶段 1 skill 校验与用户级同步、阶段 2 契约决策、阶段 2 回归测试 17/17 | [阶段 2 验收审计](plans/pdf2md-fix-manual-workflow.md#阶段-2-验收审计2026-07-12) |
