...
| [pdf-workflow-enhancement-roadmap](plans/pdf-workflow-enhancement-roadmap.md) | 待实施 | P3a：关键词检索 + 按页读取 | 所有已完成计划、P2 MCP 拆分工具、春风 150AURA 输出包 | [P2 完成](plans/pdf-workflow-enhancement-roadmap.md#完成条件) |
