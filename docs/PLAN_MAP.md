...
| [candidate-identity-business-value-decoupling](plans/candidate-identity-business-value-decoupling.md) | 提案 | 待实施 | 2026-08-11 | 150Sc 会话复盘、structured-data-extraction、data-ingestion-pipeline、semantic-parent-context-pipeline（已废弃） | [150Sc 会话问题复盘](../issues/150sc-session-feedback.md)、150Sc 包 `data/` |
