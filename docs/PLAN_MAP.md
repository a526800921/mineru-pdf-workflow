...
| [single-page-segmentation-migration](plans/single-page-segmentation-migration.md) | 实施中 | 阶段 2：页级重跑与失败回退（修复完成） | 2026-07-11 | automated-pdf-pipeline、coverage-validation-optimization、pdf-auto-repair-before-merge、per-page-anchors、demo20 第 12 页 fallback 证据 | [阶段 1 验收](plans/single-page-segmentation-migration.md#阶段-1-验收记录2026-07-11)、[阶段 2 验收](plans/single-page-segmentation-migration.md#阶段-2-验收记录2026-07-11)、[阶段 2 修复](plans/single-page-segmentation-migration.md#阶段-2-问题修复2026-07-11)、[阶段 3 实施契约](plans/single-page-segmentation-migration.md#阶段-3-实施契约确认2026-07-11) |
...
16. `single-page-segmentation-migration`（单页默认、页级重跑与 fallback；阶段 2 严格兼容验收待补）
