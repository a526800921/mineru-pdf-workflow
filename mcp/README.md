...
```json
{
  "review_markdown": "/abs/path/pdf/春风-150AURA/review.md",
  "items": [
    {
      "segment": "p0000-0019",
...
| 工具返回 `failed`: segments_dir does not exist | 分段目录未生成 | 先运行 `scripts/pdf-seg <package>/<stem>.pdf`，输出到 `<package>/segments/` |
